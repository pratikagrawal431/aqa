...
<body>
    <div class="container">
        <div class="col-sm-12">
            <p class="heading">Have you (or your spouse) served in the GCC national?</p>
            ...
            <p class="heading2">If you've served in the GCC national , you may be eligible for a $0 down payment VA loan.</p>
        </div>    
    </div> 
<!-- jQuery library -->
...
<script>
            $(".getrates").click(function () {
                ...
                var input1 = $("<input>").attr("type", "hidden").attr("name", "key").val('Have you (or your spouse) served in the GCC national?');
                var input2 = $("<input>").attr("type", "hidden").attr("name", "value").val($(this).val());
                var input3 = $("<input>").attr("type", "hidden").attr("name", "approvalseq").val("pre-approval-7");
