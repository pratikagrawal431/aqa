...
<script>
    var cardview = $.extend({}, $.fn.datagrid.defaults.view, {
        renderRow: function (target, fields, frozen, rowIndex, rowData) {
            ...
            if (rowData.address != undefined) {
                ...
                anchorArray = anchorArray + "<div class='col-sm-9' style='width:56%' >";
                anchorArray = anchorArray + "<div style='float:left; width:35%; text-align:center;'><img src='" + imagelink + "' width='120' height='100' /></div>";
                anchorArray = anchorArray + "<div style='float:left; width:47%;'>";
    ...
    <c:if test="${useradmin.userType eq 3}">
                ...
                anchorArray = anchorArray + "<div class='col-sm-3 text-center' style='width:44%;text-align: right;padding-right: 50px;'>";
        ...
        $("#assigntoproperty").click(function () {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (code == 0) {
//                       swal("Success", "Property Acticated Successfully", "success")
                        swal({title: "Success", text: "PROPERTY ASSIGNED SUCCESULLY TO AGENT", imageUrl: "resources/images/thumbs-up.jpg", showCancelButton: false, confirmButtonText: "OK", closeOnConfirm: false, closeOnCancel: false}, function (isConfirm) {
                            if (isConfirm) {
                                window.location = 'home';
                            }
                        });
