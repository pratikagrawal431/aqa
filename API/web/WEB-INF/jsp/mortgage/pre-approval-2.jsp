...
<body>
    <div class="container">
        <div class="col-sm-12">
            <p class="heading">Is this your first time buying a home?</p>
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>    
 <script>
            $(".getrates").click(function () {
                ...
                var input1 = $("<input>").attr("type", "hidden").attr("name", "key").val('Is this your first time buying a home?');
                var input2 = $("<input>").attr("type", "hidden").attr("name", "value").val($(this).val());
                var input3 = $("<input>").attr("type", "hidden").attr("name", "approvalseq").val("pre-approval-3");
