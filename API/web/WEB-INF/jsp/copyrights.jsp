...
<body>
    <div class="container">
        <div class="col-sm-12">
            <p class="privacy">Copyrights</p>
        </div>
        <div class="col-sm-12">
            <p class="privacy-heading">This application is &copy; 2016 by Aqarabia, Inc.
                <hr>
...
<ul>
<li>FBGraphClass</li>
<li>OAuthStarterKit</li>
<li>SWRevealViewController</li>
<li>DXPopover</li>
<li>SwipeView</li>
<li>OCMapViewSampleHelpAnnotation</li>
<li>OverLayCustomCallOutView</li>
<li>DonutChart</li>
<li>AFNetworking</li>
<li>Reachability</li>
<li>MBProgresshud</li>
<li>Facebook, Google and LinkedIn for Login Functionality.</li>    
</ul>   <br/>
